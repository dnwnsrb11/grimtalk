export const AiSimilarityResultPage = ({ imageSrc, similarity }) => {
  ...
  return (
    <div className="relative mt-[90px]">
      ...
      <div className="mt-4">
        <div className="h-[83px] w-full rounded-full bg-gray-200">
          <div
            className={`h-[83px] rounded-full ${barColor}`}
            style={{ width: `${similarity}%` }} // 유사도에 맞게 바 길이 조정
          >
            <div className="flex h-full w-full items-center justify-center text-[24px] font-bold text-black">
              {similarity}%
            </div>
          </div>
        </div>
